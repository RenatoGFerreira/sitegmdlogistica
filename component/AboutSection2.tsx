...
const features = [
  {
    name: "Valores",
    description:
      "Ter o cliente como foco de tudo o que faz. Reconhecer as pessoas como maior ativo, considerando seus colaboradores como parceiros de negócio. Agir com justiça, honestidade, franqueza e transparência. Buscar continuamente a excelência.",
  },
  {
    name: "Missões",
    description:
      "Ser o melhor fornecedor para os clientes, proporcionando valor diferenciado, oferecendo tecnologias inovadoras e serviços superiores",
  },
  {
    name: "Propósitos",
    description:
      "Ser a empresa de soluções logística mais eficiente (admirada) nos mercados em que atua. Formar parcerias duradouras",
  },
];
